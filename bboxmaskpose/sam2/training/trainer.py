...
class Trainer:
    ...
    def train_epoch(self, train_loader):
        ...
        os.system("bash epoch_evaluation.sh")  ## CHANGED - OUTPUT AP 50:95 XTCOCOTOOLS EVALUATION TO JSON
    ...
    def _setup_components(self):
        ...
        self.loss = None
        if self.loss_conf:
            self.loss = {key: el for (key, el) in instantiate(self.loss_conf, _convert_="all").items()}  # wrap_base_loss(el)
