# Adapted from the DeepSORT tracking library.
# Modified by Miroslav Purkrabek and Constantin Kolomiiets, BBoxMaskPose authors.
import numpy as np
import scipy.linalg
...
class KalmanFilter(object):
    ...
    def project(self, mean, covariance):
        ...
        """
        std = [self._std_weight_position * mean[3], self._std_weight_position * mean[3], 1e-1, self._std_weight_position * mean[3]]
