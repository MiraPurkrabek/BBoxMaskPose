...
def parse_args():
    ...
    parser.add_argument("--output", type=str, default="demos/outputs/bboxmaskpose", help="Directory to save outputs")
    parser.add_argument("--device", type=str, default="cuda", help="Device for inference (cuda or cpu)")
    parser.add_argument("--config", type=str, default="bmp_v2", help="BMP config (bmp_D3, bmp_J1 or bmp_v2)")
    parser.add_argument(
        "--mode",
        type=str,
        default="both",
