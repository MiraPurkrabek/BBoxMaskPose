...
def parse_args():
    ...
    parser.add_argument("--image", type=str, default="demo/data/004806.jpg", help="Path to input image")
    parser.add_argument("--output", type=str, default="demos/outputs/pmpose", help="Directory to save outputs")
    parser.add_argument("--device", type=str, default="cuda", help="Device for inference (cuda or cpu)")
    parser.add_argument("--bboxes", type=str, default=None, help="Comma-separated bbox coords: x1,y1,x2,y2;x1,y1,x2,y2;...")
