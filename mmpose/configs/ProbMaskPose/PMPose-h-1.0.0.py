...
# resume = True
load_from = "models/trained/MaskPose-h-EQ.pth"
...
model = dict(
    ...
    backbone=dict(
        ...
        # init_cfg=dict(
        #     type='Pretrained',
        #     checkpoint='models/pretrained/mae_pretrain_vit_huge_20230913.pth'),
    ),
    head=dict(
        type='MultiHead',
        in_channels=1280,
...
ochuman_dt_val_dataset = dict(
    ...
    ann_file="../ochuman_coco_format_val_range_0.00_1.00.json",
    data_prefix=dict(img='val2017/'),
    # bbox_file=OCHUMAN_ROOT + "/BMP_results/BMPx1/ochuman_all/rtmdet-l-ins_all.json",
    # bbox_file=OCHUMAN_ROOT + "/detections/rtmdet-l-ins.json",
    # bbox_file=OCHUMAN_ROOT + "/detections/rtmdet-l.json",
