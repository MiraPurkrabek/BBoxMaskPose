dataset_info = dict(
    ...
    keypoint_info={
        ...
        17: dict(name="left_finger", id=17, color=[0, 255, 0], type="lower", swap="right_finger"),
        18: dict(name="right_finger", id=18, color=[255, 128, 0], type="lower", swap="left_finger"),
        19: dict(name="left_toe", id=19, color=[0, 255, 0], type="lower", swap="right_toe"),
        20: dict(name="right_toe", id=20, color=[255, 128, 0], type="lower", swap="left_toe"),
    },
    skeleton_info={
