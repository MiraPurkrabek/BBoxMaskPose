dataset_info = dict(
    ...
    keypoint_info={
        0: dict(name="thumb4", id=0, color=[255, 128, 0], type="", swap=""),
        1: dict(name="thumb3", id=1, color=[255, 128, 0], type="", swap=""),
        2: dict(name="thumb2", id=2, color=[255, 128, 0], type="", swap=""),
        3: dict(name="thumb1", id=3, color=[255, 128, 0], type="", swap=""),
        4: dict(name="forefinger4", id=4, color=[255, 153, 255], type="", swap=""),
        5: dict(name="forefinger3", id=5, color=[255, 153, 255], type="", swap=""),
        6: dict(name="forefinger2", id=6, color=[255, 153, 255], type="", swap=""),
        7: dict(name="forefinger1", id=7, color=[255, 153, 255], type="", swap=""),
        8: dict(name="middle_finger4", id=8, color=[102, 178, 255], type="", swap=""),
        9: dict(name="middle_finger3", id=9, color=[102, 178, 255], type="", swap=""),
        10: dict(name="middle_finger2", id=10, color=[102, 178, 255], type="", swap=""),
        11: dict(name="middle_finger1", id=11, color=[102, 178, 255], type="", swap=""),
        12: dict(name="ring_finger4", id=12, color=[255, 51, 51], type="", swap=""),
        13: dict(name="ring_finger3", id=13, color=[255, 51, 51], type="", swap=""),
        14: dict(name="ring_finger2", id=14, color=[255, 51, 51], type="", swap=""),
        15: dict(name="ring_finger1", id=15, color=[255, 51, 51], type="", swap=""),
        16: dict(name="pinky_finger4", id=16, color=[0, 255, 0], type="", swap=""),
        17: dict(name="pinky_finger3", id=17, color=[0, 255, 0], type="", swap=""),
        18: dict(name="pinky_finger2", id=18, color=[0, 255, 0], type="", swap=""),
        19: dict(name="pinky_finger1", id=19, color=[0, 255, 0], type="", swap=""),
        20: dict(name="wrist", id=20, color=[255, 255, 255], type="", swap=""),
    },
    skeleton_info={
