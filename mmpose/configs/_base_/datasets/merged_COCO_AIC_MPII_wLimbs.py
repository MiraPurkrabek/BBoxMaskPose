...
################################################################
        ...
        24:
        dict(
            name='left_little_toe',
            id=24,
            color=[51, 153, 255],
            type='lower',
            swap='right_little_toe'),
        25:
        dict(
            name='left_heel',
            id=25,
        ...
        27:
        dict(
            name='right_little_toe',
            id=27,
            color=[51, 153, 255],
            type='lower',
            swap='left_little_toe'),
        28:
        dict(
            name='right_heel',
            id=28,
        ...
        33:
        dict(
            name='left_little_tip',
            id=33,
            color=[51, 153, 255],
            type='upper',
            swap='right_little_tip'),
        ...
        38:
        dict(
            name='right_little_tip',
            id=38,
            color=[51, 153, 255],
            type='upper',
            swap='left_little_tip'),
        39:
        dict(
            name='right_mouth_corner',
            id=39,
            color=[51, 153, 255],
            type='upper',
            swap='left_mouth_corner'),
        40:
        dict(
            name='left_mouth_corner',
            id=40,
            color=[51, 153, 255],
            type='upper',
            swap='right_mouth_corner'),
    },
    skeleton_info={
        0:
    ...
    sigmas=[
        ...
        0.068, 0.066, 0.066, 0.068, 0.066, 0.066,

        # Fingers (taken from COCO-wholebody)
        0.047, 0.035, 0.026, 0.032, 0.031, 0.047, 0.035, 0.026, 0.032, 0.031,
