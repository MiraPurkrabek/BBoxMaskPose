dataset_info = dict(
    ...
    keypoint_info={
        ...
        17: dict(name="thorax_mpii", id=17, color=[51, 153, 255], type="upper", swap=""),
        18: dict(name="pelvis_mpii", id=18, color=[51, 153, 255], type="lower", swap=""),
        19: dict(name="neck_mpii", id=19, color=[51, 153, 255], type="upper", swap=""),
        20: dict(name="head_top_mpii", id=20, color=[51, 153, 255], type="upper", swap=""),
        21: dict(name="neck_aic", id=21, color=[51, 153, 255], type="upper", swap=""),
        22: dict(name="head_top_aic", id=22, color=[51, 153, 255], type="upper", swap=""),
        ################################################################
        23: dict(name="left_big_toe", id=23, color=[51, 153, 255], type="lower", swap="right_big_toe"),
        24: dict(name="left_little_toe", id=24, color=[51, 153, 255], type="lower", swap="right_little_toe"),
        25: dict(name="left_heel", id=25, color=[51, 153, 255], type="lower", swap="right_heel"),
        26: dict(name="right_big_toe", id=26, color=[51, 153, 255], type="lower", swap="left_big_toe"),
        27: dict(name="right_little_toe", id=27, color=[51, 153, 255], type="lower", swap="left_little_toe"),
        28: dict(name="right_heel", id=28, color=[51, 153, 255], type="lower", swap="left_heel"),
        29: dict(name="left_thumb_tip", id=29, color=[51, 153, 255], type="upper", swap="right_thumb_tip"),
        30: dict(name="left_index_tip", id=30, color=[51, 153, 255], type="upper", swap="right_index_tip"),
        31: dict(name="left_middle_tip", id=31, color=[51, 153, 255], type="upper", swap="right_middle_tip"),
        32: dict(name="left_ring_tip", id=32, color=[51, 153, 255], type="upper", swap="right_ring_tip"),
        33: dict(name="left_little_tip", id=33, color=[51, 153, 255], type="upper", swap="right_little_tip"),
        34: dict(name="right_thumb_tip", id=34, color=[51, 153, 255], type="upper", swap="left_thumb_tip"),
        35: dict(name="right_index_tip", id=35, color=[51, 153, 255], type="upper", swap="left_index_tip"),
        36: dict(name="right_middle_tip", id=36, color=[51, 153, 255], type="upper", swap="left_middle_tip"),
        37: dict(name="right_ring_tip", id=37, color=[51, 153, 255], type="upper", swap="left_ring_tip"),
        38: dict(name="right_little_tip", id=38, color=[51, 153, 255], type="upper", swap="left_little_tip"),
        39: dict(name="right_mouth_corner", id=39, color=[51, 153, 255], type="upper", swap="left_mouth_corner"),
        40: dict(name="left_mouth_corner", id=40, color=[51, 153, 255], type="upper", swap="right_mouth_corner"),
    },
    skeleton_info={
    ...
    joint_weights=[
        ...
        1.0,
        1.0,
        # Down-weight toes, heels, fingers and mouth corners as the resolution might be low
        0.8,
        0.8,
        0.8,
        0.8,
    ...
    sigmas=[
        ...
        0.079,
        0.079,
        # Toes and heels (taken from COCO-wholebody; values for left feet as the original COCO-wb eval is not symmetric)
        0.068,
        0.066,
        0.066,
        0.068,
        0.066,
        0.066,
        # Fingers (taken from COCO-wholebody)
        0.047,
        0.035,
        0.026,
        0.032,
        ...
        0.032,
        0.031,
        # Mouth corners (taken from COCO-wholebody)
        0.008,
        0.008,
    ],
)
