dataset_info = dict(
    ...
    keypoint_info={
        ...
        11: dict(name="right_elbow", id=11, color=[255, 128, 0], type="upper", swap="left_elbow"),
        12: dict(name="right_shoulder", id=12, color=[255, 128, 0], type="upper", swap="left_shoulder"),
        13: dict(name="left_shoulder", id=13, color=[0, 255, 0], type="upper", swap="right_shoulder"),
        14: dict(name="left_elbow", id=14, color=[0, 255, 0], type="upper", swap="right_elbow"),
        15: dict(name="left_wrist", id=15, color=[0, 255, 0], type="upper", swap="right_wrist"),
    },
    skeleton_info={
    ...
    joint_weights=[1.5, 1.2, 1.0, 1.0, 1.2, 1.5, 1.0, 1.0, 1.0, 1.0, 1.5, 1.2, 1.0, 1.0, 1.2, 1.5],
    # Adapted from COCO dataset.
    sigmas=[0.089, 0.083, 0.107, 0.107, 0.083, 0.089, 0.026, 0.026, 0.026, 0.026, 0.062, 0.072, 0.179, 0.179, 0.072, 0.062],
)
