...
model = dict(
    ...
    test_cfg=dict(multiscale_test=False, flip_test=True, shift_heatmap=False, restore_heatmap_size=True, align_corners=False),
)
...
val_pipeline = [
    dict(type="LoadImage"),
    dict(type="BottomupResize", input_size=codec["input_size"], size_factor=64, resize_mode="expand"),
    dict(
        type="PackPoseInputs",
        meta_keys=(
            "id",
