...
# learning policy
param_scheduler = [dict(type="MultiStepLR", begin=0, end=140, milestones=[90, 120], gamma=0.1, by_epoch=True)]
...
model = dict(
    ...
    test_cfg=dict(multiscale_test=False, flip_test=True, shift_heatmap=False, align_corners=False),
)
