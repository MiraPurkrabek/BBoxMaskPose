...
param_scheduler = [
    ...
    dict(type="MultiStepLR", begin=0, end=140, milestones=[90, 120], gamma=0.1, by_epoch=True),
]
...
model = dict(
    ...
    head=dict(
        ...
        rescore_cfg=dict(
            ...
            norm_indexes=(5, 6),
            init_cfg=dict(
                type="Pretrained", checkpoint="https://download.openmmlab.com/mmpose/" "pretrain_models/kpt_rescore_coco-33d58c5c.pth"
            ),
        ),
    ),
