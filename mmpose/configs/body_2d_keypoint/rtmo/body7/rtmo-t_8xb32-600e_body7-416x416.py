...
train_pipeline_stage1 = [
    ...
    dict(type="Mosaic", img_scale=(416, 416), pad_val=114.0, pre_transform=[dict(type="LoadImage", backend_args=None)]),
    dict(
...
custom_hooks = [
    ...
    dict(
        ...
        epoch_attributes={
            280: {"proxy_target_cc": True, "loss_mle.loss_weight": 5.0, "loss_oks.loss_weight": 10.0},
        },
        priority=48,
    ),
...
model = dict(
    ...
    data_preprocessor=dict(
        ...
        std=[1, 1, 1],
        batch_augments=[
            dict(type="BatchSyncRandomResize", random_size_range=(320, 640), size_divisor=32, interval=1),
        ],
    ),
    backbone=dict(
        type="CSPDarknet",
