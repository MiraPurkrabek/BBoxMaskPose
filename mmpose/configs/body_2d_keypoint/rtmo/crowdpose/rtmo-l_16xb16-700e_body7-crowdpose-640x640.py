...
param_scheduler = [
    ...
    dict(type="CosineAnnealingLR", eta_min=0.0002, begin=5, T_max=350, end=349, by_epoch=True, convert_to_iter_based=True),
    ...
    dict(type="CosineAnnealingLR", eta_min=0.0002, begin=350, T_max=320, end=670, by_epoch=True, convert_to_iter_based=True),
...
train_pipeline_stage1 = [
    ...
    dict(type="Mosaic", img_scale=(640, 640), pad_val=114.0, pre_transform=[dict(type="LoadImage", backend_args=None)]),
    dict(
...
# mapping
aic_crowdpose = [(3, 0), (0, 1), (4, 2), (1, 3), (5, 4), (2, 5), (9, 6), (6, 7), (10, 8), (7, 9), (11, 10), (8, 11), (12, 12), (13, 13)]
...
jhmdb_crowdpose = [(4, 0), (3, 1), (8, 2), (7, 3), (12, 4), (11, 5), (6, 6), (5, 7), (10, 8), (9, 9), (14, 10), (13, 11), (2, 12), (0, 13)]
...
dataset_crowdpose = dict(
    ...
    pipeline=[dict(type="KeypointConverter", num_keypoints=14, mapping=[(i, i) for i in range(14)])],
)
...
dataset_jhmdb = dict(
    ...
    pipeline=[dict(type="KeypointConverter", num_keypoints=14, mapping=jhmdb_crowdpose)],
)
...
dataset_halpe = dict(
    ...
    pipeline=[dict(type="KeypointConverter", num_keypoints=14, mapping=halpe_crowdpose)],
)
...
dataset_posetrack = dict(
    ...
    pipeline=[dict(type="KeypointConverter", num_keypoints=14, mapping=posetrack_crowdpose)],
)
...
val_pipeline = [
    ...
    dict(
        type="PackPoseInputs", meta_keys=("id", "img_id", "img_path", "ori_shape", "img_shape", "input_size", "input_center", "input_scale")
    ),
]
...
custom_hooks = [
    ...
    dict(type="EMAHook", ema_type="ExpMomentumEMA", momentum=0.0002, update_buffers=True, strict_load=False, priority=49),
]
...
model = dict(
    ...
    init_cfg=dict(type="Kaiming", layer="Conv2d", a=2.23606797749979, distribution="uniform", mode="fan_in", nonlinearity="leaky_relu"),
    data_preprocessor=dict(
        ...
        std=[1, 1, 1],
        batch_augments=[
            dict(type="BatchSyncRandomResize", random_size_range=(480, 800), size_divisor=32, interval=1),
        ],
    ),
    backbone=dict(
        type="CSPDarknet",
    ...
    head=dict(
        ...
        assigner=dict(type="SimOTAAssigner", dynamic_k_indicator="oks", oks_calculator=dict(type="PoseOKS", metainfo=metafile)),
