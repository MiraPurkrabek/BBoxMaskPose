...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(img="ai_challenger_keypoint_validation_20170911/" "keypoint_validation_images_20170911/"),
        test_mode=True,
...
# evaluators
val_evaluator = dict(type="CocoMetric", ann_file=data_root + "annotations/aic_val.json", use_area=False)
