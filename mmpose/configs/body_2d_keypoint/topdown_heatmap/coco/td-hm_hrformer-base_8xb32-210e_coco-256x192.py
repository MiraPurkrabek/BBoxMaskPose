...
model = dict(
    ...
    backbone=dict(
        ...
        extra=dict(
            ...
            with_rpe=True,
            stage1=dict(
                num_modules=1, num_branches=1, block="BOTTLENECK", num_blocks=(2,), num_channels=(64,), num_heads=[2], mlp_ratios=[4]
            ),
            stage2=dict(
                num_modules=1,
                num_branches=2,
        ...
        init_cfg=dict(
            type="Pretrained", checkpoint="https://download.openmmlab.com/mmpose/" "pretrain_models/hrformer_base-32815020_20220226.pth"
        ),
    ),
    head=dict(
        type="HeatmapHead",
