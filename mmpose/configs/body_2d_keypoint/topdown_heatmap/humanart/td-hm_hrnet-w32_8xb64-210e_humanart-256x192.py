...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        bbox_file=f"{data_root}HumanArt/person_detection_results/" "HumanArt_validation_detections_AP_H_56_person.json",
        data_prefix=dict(img=""),
        test_mode=True,
...
# evaluators
val_evaluator = dict(type="CocoMetric", ann_file=data_root + "HumanArt/annotations/validation_humanart.json")
