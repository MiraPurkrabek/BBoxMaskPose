...
param_scheduler = [
    ...
    dict(type="MultiStepLR", begin=0, end=40, milestones=[20, 30], gamma=0.1, by_epoch=True),
]
...
model = dict(
    ...
    backbone=dict(type="CPM", in_channels=3, out_channels=15, feat_channels=128, num_stages=6),
    head=dict(
        type="CPMHead",
        in_channels=15,
        out_channels=15,
