...
param_scheduler = [
    ...
    dict(type="MultiStepLR", begin=0, end=20, milestones=[10, 15], gamma=0.1, by_epoch=True),
]
...
# hooks
default_hooks = dict(checkpoint=dict(save_best="posetrack18/Total AP", rule="greater", interval=1))
