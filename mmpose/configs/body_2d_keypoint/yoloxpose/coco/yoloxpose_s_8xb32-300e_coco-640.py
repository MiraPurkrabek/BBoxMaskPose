...
# runtime
train_cfg = dict(_delete_=True, type="EpochBasedTrainLoop", max_epochs=300, val_interval=10, dynamic_intervals=[(280, 1)])
...
model = dict(
    ...
    head=dict(
        ...
        loss_oks=dict(
            type="OKSLoss", reduction="none", metainfo="configs/_base_/datasets/coco.py", norm_target_weight=True, loss_weight=30.0
        ),
