...
# learning policy
param_scheduler = [dict(type="StepLR", step_size=100000, gamma=0.96, end=80, by_epoch=False)]

auto_scale_lr = dict(base_batch_size=512)

# hooks
default_hooks = dict(checkpoint=dict(type="CheckpointHook", save_best="MPJPE", rule="less", max_keep_ckpts=1))
...
train_pipeline = [
    ...
    dict(
        type="PackPoseInputs",
        meta_keys=("id", "category_id", "target_img_path", "flip_indices", "target_root", "target_root_index", "target_mean", "target_std"),
    ),
]
