...
# codec settings
train_codec = dict(type="MotionBERTLabel", num_keypoints=17, concat_vis=True, mode="train")
val_codec = dict(type="MotionBERTLabel", num_keypoints=17, concat_vis=True, rootrel=True)
...
train_pipeline = [
    ...
    dict(type="PackPoseInputs", meta_keys=("id", "category_id", "target_img_path", "flip_indices", "factor", "camera_param")),
]
val_pipeline = [
...
val_evaluator = [dict(type="MPJPE", mode="mpjpe", skip_list=skip_list), dict(type="MPJPE", mode="p-mpjpe", skip_list=skip_list)]
