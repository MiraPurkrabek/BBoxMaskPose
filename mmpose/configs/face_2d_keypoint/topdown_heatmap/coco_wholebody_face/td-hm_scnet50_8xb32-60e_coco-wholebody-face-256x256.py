...
param_scheduler = [
    ...
    dict(type="MultiStepLR", begin=0, end=210, milestones=[40, 55], gamma=0.1, by_epoch=True),
]
...
model = dict(
    ...
    backbone=dict(
        type="SCNet",
        depth=50,
        init_cfg=dict(type="Pretrained", checkpoint="https://download.openmmlab.com/mmpose/" "pretrain_models/scnet50-7ef0a199.pth"),
    ),
    head=dict(
