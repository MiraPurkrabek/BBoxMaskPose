...
class CoDINOHead(DINOHead):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if "two_stage_num_proposals" in transformer:
            assert transformer["two_stage_num_proposals"] == num_query, "two_stage_num_proposals must be equal to num_query for DINO"
        else:
    ...
    def predict_by_feat(self, all_cls_scores, all_bbox_preds, enc_cls_scores, enc_bbox_preds, enc_outputs, batch_img_metas, rescale=True):
