...
test_pipeline = [
    ...
    dict(
        type="PackDetInputs", meta_keys=("img_id", "img_path", "ori_shape", "img_shape", "scale_factor", "instances", "image_level_labels")
    ),
]
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        image_level_ann_file="annotations/validation-" "annotations-human-imagelabels-boxable.csv",
...
val_evaluator = dict(type="OpenImagesMetric", iou_thrs=0.5, ioa_thrs=0.5, use_group_of=True, get_supercategory=True)
