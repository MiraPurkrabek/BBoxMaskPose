...
model = dict(
    ...
    roi_head=dict(
        ...
        shared_head=dict(type="ResLayer", depth=50, stage=3, stride=2, dilation=1, style="caffe", norm_cfg=norm_cfg, norm_eval=True),
    ...
    test_cfg=dict(
        rpn=dict(nms_pre=6000, nms=dict(type="nms", iou_threshold=0.7), max_per_img=1000, min_bbox_size=0),
