...
model = dict(
    ...
    neck=dict(type="CTResNetNeck", in_channels=512, num_deconv_filters=(256, 128, 64), num_deconv_kernels=(4, 4, 4), use_dcn=True),
    bbox_head=dict(
        type="CenterNetHead",
        num_classes=80,
        in_channels=64,
...
param_scheduler = [
    ...
    dict(type="MultiStepLR", begin=0, end=max_epochs, by_epoch=True, milestones=[18, 24], gamma=0.1),  # the real step is [18*5, 24*5]
]
