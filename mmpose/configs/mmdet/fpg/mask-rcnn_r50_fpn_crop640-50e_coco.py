...
model = dict(
    ...
    neck=dict(type="FPN", in_channels=[256, 512, 1024, 2048], out_channels=256, norm_cfg=norm_cfg, num_outs=5),
...
train_pipeline = [
    ...
    dict(type="RandomCrop", crop_type="absolute_range", crop_size=image_size, allow_negative_crop=True),
