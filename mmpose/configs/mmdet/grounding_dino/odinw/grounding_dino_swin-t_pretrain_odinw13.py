...
val_evaluator_CottontailRabbits = dict(type="CocoMetric", ann_file=_data_root + "valid/annotations_without_background.json", metric="bbox")
...
val_evaluator_EgoHands = dict(type="CocoMetric", ann_file=_data_root + "valid/annotations_without_background.json", metric="bbox")
