...
model = dict(
    data_preprocessor=dict(mean=[103.53, 116.28, 123.675], std=[57.375, 57.12, 58.395], bgr_to_rgb=False),
    backbone=dict(
        _delete_=True,
        type="HRNet",
        extra=dict(
    ...
    neck=dict(_delete_=True, type="HRFPN", in_channels=[32, 64, 128, 256], out_channels=256, stride=2, num_outs=5),
)
