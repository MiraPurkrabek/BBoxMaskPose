...
model = dict(
    ...
    teacher_neck=dict(
        type="FPN", in_channels=[256, 512, 1024, 2048], out_channels=256, start_level=1, add_extra_convs="on_output", num_outs=5
    ),
    ...
    test_cfg=dict(
        nms_pre=1000, min_bbox_size=0, score_thr=0.05, score_voting=True, nms=dict(type="nms", iou_threshold=0.6), max_per_img=100
    ),
)
