...
model = dict(
    ...
    roi_head=dict(bbox_head=dict(loss_bbox=dict(_delete_=True, type="BalancedL1Loss", alpha=0.5, gamma=1.5, beta=1.0, loss_weight=1.0))),
...
train_dataloader = dict(dataset=dict(proposal_file="libra_proposals/rpn_r50_fpn_1x_train2017.pkl"))
...
val_dataloader = dict(dataset=dict(proposal_file="libra_proposals/rpn_r50_fpn_1x_val2017.pkl"))
