            ...
            encoder=dict(  # DeformableDetrTransformerEncoder
                ...
                layer_cfg=dict(  # DeformableDetrTransformerEncoderLayer
                    self_attn_cfg=dict(  # MultiScaleDeformableAttention
                        embed_dims=256, num_heads=8, num_levels=3, num_points=4, im2col_step=128, dropout=0.0, batch_first=True
                    ),
                    ffn_cfg=dict(
...
default_hooks = dict(
    checkpoint=dict(type="CheckpointHook", by_epoch=False, save_last=True, interval=2000),
    visualization=dict(type="TrackVisualizationHook", draw=False),
)
log_processor = dict(type="LogProcessor", window_size=50, by_epoch=False)

# evaluator
val_evaluator = dict(type="YouTubeVISMetric", metric="youtube_vis_ap", outfile_prefix="./youtube_vis_results", format_only=True)
