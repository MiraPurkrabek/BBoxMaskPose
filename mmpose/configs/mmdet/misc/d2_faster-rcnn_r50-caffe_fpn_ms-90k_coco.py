...
model = dict(
    ...
    detector=dict(
        ...
        resnets=dict(depth=50, out_features=["res2", "res3", "res4", "res5"], num_groups=1, norm="FrozenBN"),
        fpn=dict(in_features=["res2", "res3", "res4", "res5"], out_channels=256),
        anchor_generator=dict(
            name="DefaultAnchorGenerator", sizes=[[32], [64], [128], [256], [512]], aspect_ratios=[[0.5, 1.0, 2.0]], angles=[[-90, 0, 90]]
        ),
