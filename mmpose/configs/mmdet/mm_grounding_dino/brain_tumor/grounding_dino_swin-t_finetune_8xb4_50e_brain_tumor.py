...
val_dataloader = dict(
    dataset=dict(
        metainfo=metainfo, data_root=data_root, return_classes=True, ann_file="valid/" + label_name, data_prefix=dict(img="valid/")
    )
)
test_dataloader = val_dataloader

val_evaluator = dict(type="CocoMetric", ann_file=data_root + "valid/" + label_name, metric="bbox", format_only=False)
...
# learning policy
max_epochs = 5
param_scheduler = [dict(type="MultiStepLR", begin=0, end=max_epochs, by_epoch=True, milestones=[4], gamma=0.1)]
