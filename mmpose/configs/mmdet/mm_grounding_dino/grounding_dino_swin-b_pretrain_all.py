...
train_dataloader = dict(
    ...
    num_workers=4,
    sampler=dict(
        _delete_=True, type="CustomSampleSizeSampler", ratio_mode=True, dataset_size=[-1, -1, 0.07, -1, -1, -1, -1, -1, -1, -1, -1, -1]
    ),
    dataset=dict(
        datasets=[
...
# learning policy
max_iter = 304680
train_cfg = dict(_delete_=True, type="IterBasedTrainLoop", max_iters=max_iter, val_interval=10000)

param_scheduler = [
    dict(type="LinearLR", start_factor=0.1, by_epoch=False, begin=0, end=1000),
    dict(type="MultiStepLR", begin=0, end=max_iter, by_epoch=False, milestones=[228510], gamma=0.1),
]

default_hooks = dict(checkpoint=dict(by_epoch=False, interval=10000, max_keep_ckpts=20))
