...
max_iter = 250000
train_cfg = dict(_delete_=True, type="IterBasedTrainLoop", max_iters=max_iter, val_interval=13000)

param_scheduler = [
    dict(type="LinearLR", start_factor=0.1, by_epoch=False, begin=0, end=1000),
    dict(type="MultiStepLR", begin=0, end=max_iter, by_epoch=False, milestones=[210000], gamma=0.1),
]
