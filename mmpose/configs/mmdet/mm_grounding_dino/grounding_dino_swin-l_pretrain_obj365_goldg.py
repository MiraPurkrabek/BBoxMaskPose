...
train_dataloader = dict(dataset=dict(datasets=[o365v2_dataset, oiv6_dataset, flickr30k_dataset, gqa_dataset]))
...
param_scheduler = [
    ...
    dict(type="MultiStepLR", begin=0, end=max_iter, by_epoch=False, milestones=[156100], gamma=0.5),
]
