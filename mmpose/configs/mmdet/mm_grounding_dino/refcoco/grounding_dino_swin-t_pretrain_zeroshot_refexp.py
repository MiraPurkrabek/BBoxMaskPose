...
test_pipeline = [
    ...
    dict(
        type="PackDetInputs",
        meta_keys=("img_id", "img_path", "ori_shape", "img_shape", "scale_factor", "text", "custom_entities", "tokens_positive"),
    ),
]
...
val_evaluator_all_val = dict(type="RefExpMetric", ann_file=data_root + ann_file, metric="bbox", iou_thrs=0.5, topk=(1, 5, 10))
...
val_evaluator_refcoco_testA = dict(type="RefExpMetric", ann_file=data_root + ann_file, metric="bbox", iou_thrs=0.5, topk=(1, 5, 10))
...
val_evaluator_refcoco_testB = dict(type="RefExpMetric", ann_file=data_root + ann_file, metric="bbox", iou_thrs=0.5, topk=(1, 5, 10))
...
val_evaluator_refcoco_plus_testA = dict(type="RefExpMetric", ann_file=data_root + ann_file, metric="bbox", iou_thrs=0.5, topk=(1, 5, 10))
...
val_evaluator_refcoco_plus_testB = dict(type="RefExpMetric", ann_file=data_root + ann_file, metric="bbox", iou_thrs=0.5, topk=(1, 5, 10))
...
val_evaluator_refcocog_test = dict(type="RefExpMetric", ann_file=data_root + ann_file, metric="bbox", iou_thrs=0.5, topk=(1, 5, 10))
...
val_evaluator_grefcoco_val = dict(
    type="gRefCOCOMetric", ann_file=data_root + ann_file, metric="bbox", iou_thrs=0.5, thresh_score=0.7, thresh_f1=1.0
)
