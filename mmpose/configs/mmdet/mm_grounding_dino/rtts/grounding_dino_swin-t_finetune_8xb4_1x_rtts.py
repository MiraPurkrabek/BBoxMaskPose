...
val_dataloader = dict(
    dataset=dict(
        metainfo=metainfo, data_root=data_root, return_classes=True, ann_file="annotations_json/rtts_val.json", data_prefix=dict(img="")
    )
)
test_dataloader = val_dataloader

val_evaluator = dict(type="CocoMetric", ann_file=data_root + "annotations_json/rtts_val.json", metric="bbox", format_only=False)
