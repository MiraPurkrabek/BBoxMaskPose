...
data_root = "data/RUOD/"
class_name = ("holothurian", "echinus", "scallop", "starfish", "fish", "corals", "diver", "cuttlefish", "turtle", "jellyfish")
palette = [
    (235, 211, 70),
    (106, 90, 205),
    (160, 32, 240),
...
val_evaluator = dict(type="CocoMetric", ann_file=data_root + "RUOD_ANN/instances_test.json", metric="bbox", format_only=False)
