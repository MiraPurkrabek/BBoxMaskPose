...
model = dict(roi_head=dict(bbox_head=dict(num_classes=500)), test_cfg=dict(rcnn=dict(score_thr=0.01)))
...
val_dataloader = dict(
    dataset=dict(
        ...
        image_level_ann_file="challenge2019/challenge-2019-validation-" "detection-human-imagelabels.csv",
    )
)
