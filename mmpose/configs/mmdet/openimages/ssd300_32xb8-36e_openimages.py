...
model = dict(bbox_head=dict(num_classes=601, anchor_generator=dict(basesize_ratio_range=(0.2, 0.9))))
# dataset settings
...
test_pipeline = [
    ...
    dict(type="LoadAnnotations", with_bbox=True),
    dict(type="PackDetInputs", meta_keys=("img_id", "img_path", "ori_shape", "img_shape", "scale_factor", "instances")),
]
...
# optimizer
optim_wrapper = dict(optimizer=dict(type="SGD", lr=0.04, momentum=0.9, weight_decay=5e-4))
# learning rate
param_scheduler = [
