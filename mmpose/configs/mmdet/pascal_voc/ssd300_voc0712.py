...
model = dict(bbox_head=dict(num_classes=20, anchor_generator=dict(basesize_ratio_range=(0.2, 0.9))))
# dataset settings
...
param_scheduler = [
    ...
    dict(type="MultiStepLR", begin=0, end=24, by_epoch=True, milestones=[16, 20], gamma=0.1),
]
