...
model = dict(
    type="BaseReID",
    data_preprocessor=dict(type="ReIDDataPreprocessor", mean=[123.675, 116.28, 103.53], std=[58.395, 57.12, 57.375], to_rgb=True),
...
# optimizer
optim_wrapper = dict(type="OptimWrapper", clip_grad=None, optimizer=dict(type="SGD", lr=0.1, momentum=0.9, weight_decay=0.0001))
