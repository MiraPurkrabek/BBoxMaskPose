...
train_dataloader = dict(batch_size=8, num_workers=20, dataset=dict(pipeline=train_pipeline))
val_dataloader = dict(batch_size=5, num_workers=20, dataset=dict(pipeline=test_pipeline))
