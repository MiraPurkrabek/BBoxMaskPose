...
model = dict(
    ...
    roi_head=dict(
        ...
        glbctx_head=dict(
            type="GlobalContextHead", num_convs=4, in_channels=256, conv_out_channels=256, num_classes=80, loss_weight=3.0, conv_to_res=True
        ),
        feat_relay_head=dict(type="FeatureRelayHead", in_channels=1024, out_conv_channels=256, roi_feat_size=7, scale_factor=2),
    ),
)
