_base_ = ["../_base_/models/faster-rcnn_r50_fpn.py", "../_base_/default_runtime.py", "../_base_/datasets/semi_coco_detection.py"]
...
model = dict(
    ...
    type="SoftTeacher",
    detector=detector,
    data_preprocessor=dict(type="MultiBranchDataPreprocessor", data_preprocessor=detector.data_preprocessor),
    semi_train_cfg=dict(
        freeze_teacher=True,
        sup_weight=1.0,
        unsup_weight=4.0,
...
param_scheduler = [
    ...
    dict(type="MultiStepLR", begin=0, end=180000, by_epoch=False, milestones=[120000, 160000], gamma=0.1),
]
