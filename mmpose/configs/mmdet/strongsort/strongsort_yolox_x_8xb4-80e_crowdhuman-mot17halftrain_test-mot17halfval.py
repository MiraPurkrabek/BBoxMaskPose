...
model = dict(
    ...
    data_preprocessor=dict(
        ...
        pad_size_divisor=32,
        batch_augments=[dict(type="BatchSyncRandomResize", random_size_range=(576, 1024), size_divisor=32, interval=10)],
    ),
    detector=detector,
    reid=dict(
        type="BaseReID",
    ...
    cmc=dict(type="CameraMotionCompensation", warp_mode="cv2.MOTION_EUCLIDEAN", num_iters=100, stop_eps=0.00001),
    tracker=dict(
...
val_evaluator = dict(
    ...
    postprocess_tracklet_cfg=[dict(type="InterpolateTracklets", min_num_frames=5, max_num_frames=20, use_gsi=True, smooth_tau=10)],
)
