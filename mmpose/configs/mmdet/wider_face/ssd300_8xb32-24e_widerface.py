...
train_dataloader = dict(batch_size=32, num_workers=8, dataset=dict(pipeline=train_pipeline))
...
# optimizer
optim_wrapper = dict(optimizer=dict(lr=0.012, momentum=0.9, weight_decay=5e-4), clip_grad=dict(max_norm=35, norm_type=2))
