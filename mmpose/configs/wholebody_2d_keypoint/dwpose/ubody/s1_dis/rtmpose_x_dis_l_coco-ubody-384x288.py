...
model = dict(
    ...
    teacher_cfg="configs/wholebody_2d_keypoint/rtmpose/ubody/" "rtmpose-x_8xb32-270e_coco-ubody-wholebody-384x288.py",  # noqa: E501
    student_cfg="configs/wholebody_2d_keypoint/rtmpose/ubody/" "rtmpose-l_8xb32-270e_coco-ubody-wholebody-384x288.py",  # noqa: E501
    distill_cfg=[
        dict(
            methods=[
                dict(
