...
def parse_args():
    ...
    parser.add_argument(
        "--output-root", type=str, default="", help="root of the output img file. " "Default not saving the visualization images."
    )
        ...
        while cap.isOpened():
            ...
            if output_file:
                ...
                if video_writer is None:
                    ...
                    video_writer = cv2.VideoWriter(output_file, fourcc, 25, (frame_vis.shape[1], frame_vis.shape[0]))  # saved fps
