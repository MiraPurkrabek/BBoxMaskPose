...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type, data_root=data_root, ann_file="annotations/onehand10k_test.json", test_mode=True, pipeline=test_pipeline
    ),
)
...
# learning policy
lr_config = dict(policy="CosineAnnealing", warmup="linear", warmup_iters=500, warmup_ratio=0.001, min_lr=0)
