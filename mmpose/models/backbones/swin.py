...
class WindowMSA(BaseModule):
    ...
    def __init__(
        self, embed_dims, num_heads, window_size, qkv_bias=True, qk_scale=None, attn_drop_rate=0.0, proj_drop_rate=0.0, init_cfg=None
    ):
...
class SwinTransformer(BaseBackbone):
    ...
    def init_weights(self, pretrained=None):
        ...
        if isinstance(self.init_cfg, dict) and self.init_cfg["type"] == "Pretrained":
            ...
            state_dict = get_state_dict(self.init_cfg["checkpoint"], map_location="cpu")
            ...
            for table_key in relative_position_bias_table_keys:
                ...
                if nH1 != nH2:
                    ...
                    table_pretrained_resized = F.interpolate(
                        table_pretrained.permute(1, 0).reshape(1, nH1, S1, S1), size=(S2, S2), mode="bicubic"
                    )
