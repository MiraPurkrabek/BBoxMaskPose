...
class Basic3DBlock(BaseModule):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, conv_cfg=dict(type="Conv3d"), norm_cfg=dict(type="BN3d"), init_cfg=None):
...
class Res3DBlock(BaseModule):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=3, conv_cfg=dict(type="Conv3d"), norm_cfg=dict(type="BN3d"), init_cfg=None):
        ...
        if in_channels == out_channels:
            ...
            self.skip_con = ConvModule(
                in_channels, out_channels, 1, stride=1, padding=0, conv_cfg=conv_cfg, norm_cfg=norm_cfg, act_cfg=None, bias=True
            )
...
class Upsample3DBlock(BaseModule):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=2, stride=2, init_cfg=None):
        ...
        self.block = nn.Sequential(
            nn.ConvTranspose3d(in_channels, out_channels, kernel_size=kernel_size, stride=stride, padding=0, output_padding=0),
...
class V2VNet(BaseBackbone):
    ...
    def __init__(
        self, input_channels, output_channels, mid_channels=32, init_cfg=dict(type="Normal", std=0.001, layer=["Conv3d", "ConvTranspose3d"])
    ):
