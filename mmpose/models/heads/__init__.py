...
from .heatmap_heads import AssociativeEmbeddingHead, CIDHead, CPMHead, HeatmapHead, InternetHead, MSPNHead, ViPNASHead
from .hybrid_heads import DEKRHead, MultiHead, RTMOHead, VisPredictHead
