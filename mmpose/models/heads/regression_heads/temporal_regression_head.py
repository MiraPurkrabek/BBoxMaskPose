...
class TemporalRegressionHead(BaseHead):
    ...
    def loss(self, inputs: Tuple[Tensor], batch_data_samples: OptSampleList, train_cfg: ConfigType = {}) -> dict:
        ...
        lifting_target_label = torch.cat([d.gt_instance_labels.lifting_target_label for d in batch_data_samples])
        lifting_target_weight = torch.cat([d.gt_instance_labels.lifting_target_weight for d in batch_data_samples])
