...
class MlvlPointGenerator:
    ...
    def __init__(self, strides: Union[List[int], List[Tuple[int, int]]], offset: float = 0.5, centralize_points: bool = False) -> None:
    ...
    def grid_priors(
        self, featmap_sizes: List[Tuple], dtype: torch.dtype = torch.float32, device: DeviceType = "cuda", with_stride: bool = False
    ) -> List[Tensor]:
    ...
    def valid_flags(self, featmap_sizes: List[Tuple[int, int]], pad_shape: Tuple[int], device: DeviceType = "cuda") -> List[Tensor]:
    ...
    def single_level_valid_flags(self, featmap_size: Tuple[int, int], valid_size: Tuple[int, int], device: DeviceType = "cuda") -> Tensor:
    ...
    def sparse_priors(
        self, prior_idxs: Tensor, featmap_size: Tuple[int], level_idx: int, dtype: torch.dtype = torch.float32, device: DeviceType = "cuda"
    ) -> Tensor:
